...
Clic sur le filtre nom
    Wait until element is visible  //*[@id="filtre"]/div[1]/angular2-multiselect/div/div[1]/div   30
    Click Element  //*[@id="filtre"]/div[1]/angular2-multiselect/div/div[1]/div
    Sleep  2
    Input text  //*[@id="filtre"]/div[1]/angular2-multiselect/div/div[2]/div[3]/div[2]/input   test
    Sleep  3
    Click Element   //*[@id="filtre"]/div[1]/angular2-multiselect/div/div[2]/div[3]/ul/span/li[4]
    Sleep  2
    Click element  //*[@id="regles_tab_info"]/tbody/tr[1]/td[10]/div/div/label
    Sleep  2
 ...
 Verifier les champs de saisie
  ...
  Sleep  2
  Click Element  ${txt_scope}
  Sleep  2
  Click Element  ${txt_network}
  Sleep  2
  Page Should Contain Element  //*[@id="step1"]/div/div[1]/div/div[1]/div/div/span/span
  Sleep  2

Clic sur la barre de recherche
  Wait until element is visible  //*[@id="orange-navbar-collapse"]/ul/li[9]/div/li[1]/div/form/input  30
  Input text  //*[@id="orange-navbar-collapse"]/ul/li[9]/div/li[1]/div/form/input   RegleDATA
  Sleep  2
  Click element  //*[@id="orange-navbar-collapse"]/ul/li[9]/div/li[1]/div/form/button/i
  Sleep  2
  Click Element   ${btn_reset}
  Sleep  2

Multiple choix de destination
  Click Element  //*[@id="filtre"]/div[5]/angular2-multiselect/div/div[1]/div
  input text  //*[@id="filtre"]/div[5]/angular2-multiselect/div/div[2]/div[3]/div[2]/input  data
  Click Element  //*[@id="filtre"]/div[5]/angular2-multiselect/div/div[2]/div[3]/ul/span/li/label[2]
  Sleep  2
  Click Element  //*[@id="regles_tab_info"]/tbody/tr[1]
  Scroller vers le bas
  Click Element  xpath=/html/body/jhi-main/div[2]/div/div/jhi-regle-detail/div/div/div[2]/div/div/div[1]/div[2]/div[2]/button[1]
  ...
  Click Element  //*[@id="senstrafic"]/angular2-multiselect/div/div[1]/div
  Sleep  3
  Click Element  //*[@id="senstrafic"]/angular2-multiselect/div/div[2]/div[3]/div[1]/label
  Sleep  2
  Scroller vers le bas
  Click Element  //*[@id="form-add-rule"]/div/div[2]/button[2]
  Sleep  2
  Click Element  //*[@id="form-add-rule"]/div/div[2]/button[3]
  Sleep  2
  Execute Javascript   window.scrollTo(190, 102)
  Sleep  2
  Click Element  //*[@id="filtre"]/div[1]/angular2-multiselect/div/div[1]/div
  Sleep  2
  Input text  //*[@id="filtre"]/div[1]/angular2-multiselect/div/div[2]/div[3]/div[2]/input  RegleDATA
  Sleep  2
  Click Element  xpath=//*[@id="filtre"]/div[1]/angular2-multiselect/div/div[2]/div[3]/ul/span/li[1]/label
  Sleep  2
  Click Element  //*[@id="regles_tab_info"]/tbody/tr[1]
  Scroller vers le bas
...
Purger la zone de selection des destinations
   Click Element  //*[@id="filtre"]/div[1]/angular2-multiselect/div/div[1]/div
  Sleep  2
  Input text  //*[@id="filtre"]/div[1]/angular2-multiselect/div/div[2]/div[3]/div[2]/input  testAwa
  Sleep  2
  Click Element  xpath=//*[@id="filtre"]/div[1]/angular2-multiselect/div/div[2]/div[3]/ul/span/li[1]/label
  Sleep  2
  Click Element  //*[@id="regles_tab_info"]/tbody/tr[1]
  Sleep  2
  Scroller vers le bas
  Click Element  xpath=/html/body/jhi-main/div[2]/div/div/jhi-regle-detail/div/div/div[2]/div/div/div[1]/div[2]/div[2]/button[1]/span
  Execute Javascript   window.scrollTo(738, 96)
  Sleep  2
  Click Element   //*[@id="field_flux"]
  Sleep  2
  Select From List By Label    xpath=//*[@id="field_flux"]   Roaming in
  Sleep  2

Recuperer les flux en fonction du réseau et du scope choisi
    Clic sur le bouton Creer une nouvelle regle
    Input text  ${txt_name}  KOUNA
    Input text  ${txt_name_description}  testKouna
    @{Networks}  Create List  Fixe  Mobile
    FOR  ${Item}  IN  @{Networks}
    Run Keyword If  '${Item}' == '${Item}'   Select From List By Label  ${txt_network}   ${Item}  ELSE  Continue For Loop
    Sleep  2
    Click Element  ${txt_scope}
    Sleep  2
    Select From List By Label  ${txt_scope}   Voix
    Sleep  2
    Click Element  ${txt_flux}
    Sleep  2
    END